...
lists_path = 'C:/Users/Fox0197/Desktop/funktion/searchlists//'
...
def get_meta(input):
	...
	korp0 = os.path.abspath(input).split(os.path.sep)[korp_folder]
...
def support_all_lang(lang):
	...
	if lang == 'en':
		...
		stoplist = open(file0, 'r', encoding='utf-8').readlines()
		pseudo_deverbs = []
		for wd in stoplist:
			wd = wd.strip()
			pseudo_deverbs.append(wd)
		
		file1 = open(lists_path + "en_adv_quantifiers.lst", 'r', encoding='utf-8').readlines()
		quantifiers = []
		for q in file1:
			q = q.strip()
			quantifiers.append(q)

		file2 = open(lists_path + "en_modal-adj_predicates.lst", 'r', encoding='utf-8').readlines()
		adj_pred = []
		for adj in file2:
			adj = adj.strip()
			adj_pred.append(adj)

		file3 = open(lists_path + "en_converts.lst", 'r', encoding='utf-8').readlines()
		converts = []
		for conv in file3:
			conv = conv.strip()
	...
	if lang == 'de':
		...
		file1 = open(lists_path + "de_adv_quantifiers.lst", 'r', encoding='utf-8').readlines()
		quantifiers = []
		for q in file1:
			q = q.strip()
			quantifiers.append(q)
		
		file3 = open(lists_path + "de_modal-adj_predicates.lst", 'r', encoding='utf-8').readlines()
		adj_pred = []
		for adj in file3:
			adj = adj.strip()
			adj_pred.append(adj)

		file4 = open(lists_path + "de_converts.lst", 'r', encoding='utf-8').readlines()
		converts = []
		for conv in file4:
			conv = conv.strip()
			converts.append(conv)
	...
	if lang == 'ru':
		...
		file1 = open(lists_path + "ru_adv_quantifiers.lst", 'r', encoding='utf-8').readlines()
		quantifiers = []
		for q in file1:
			q = q.strip()
			quantifiers.append(q)

		file2 = open(lists_path + "ru_modal-adj_predicates.lst", 'r', encoding='utf-8').readlines()
		adj_pred = []
		for adj in file2:
			adj = adj.strip()
			adj_pred.append(adj)
